...
var _excluded14 = ["children", "components", "componentsProps", "className", "invisible", "open", "transitionDuration", "TransitionComponent"];
...
var Backdrop = React15.forwardRef(function Backdrop2(inProps, ref) {
  ...
  return (0, import_jsx_runtime17.jsx)(TransitionComponent, _extends({
    ...
    children: (0, import_jsx_runtime17.jsx)(BackdropUnstyled_default, {
      className,
      invisible,
      components: _extends({
        Root: BackdropRoot
...
var _excluded15 = ["BackdropComponent", "closeAfterTransition", "children", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted"];
...
var Select = React22.forwardRef(function Select2(inProps, ref) {
  ...
  return React22.cloneElement(InputComponent, _extends({
    inputComponent,
    inputProps: _extends({
      children,
      IconComponent,
...
//# sourceMappingURL=chunk-SXMMMSDR.js.map
