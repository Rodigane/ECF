...
var _excluded4 = ["avatar", "className", "clickable", "color", "component", "deleteIcon", "disabled", "icon", "label", "onClick", "onDelete", "onKeyDown", "onKeyUp", "size", "variant"];
...
var _excluded6 = ["children", "className", "componentsProps", "max", "spacing", "total", "variant"];
var SPACINGS = {
  small: -16,
  medium: null
};
...
var Tab = React13.forwardRef(function Tab2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTab"
  });
  ...
  const icon = iconProp && label && React13.isValidElement(iconProp) ? React13.cloneElement(iconProp, {
  ...
  return (0, import_jsx_runtime16.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime16.jsxs)(React13.Fragment, {
      children: [icon, label]
...
var _excluded8 = ["className", "direction", "orientation", "disabled"];
...
var TabScrollButton = React16.forwardRef(function TabScrollButton2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTabScrollButton"
  });
  ...
  return (0, import_jsx_runtime19.jsx)(TabScrollButtonRoot, _extends({
    ...
    children: direction === "left" ? _KeyboardArrowLeft || (_KeyboardArrowLeft = (0, import_jsx_runtime19.jsx)(KeyboardArrowLeft_default, {
      fontSize: "small"
    })) : _KeyboardArrowRight || (_KeyboardArrowRight = (0, import_jsx_runtime19.jsx)(KeyboardArrowRight_default, {
      fontSize: "small"
    }))
  }));
});
...
function ScrollbarSize(props) {
  ...
  const scrollbarHeight = React17.useRef();
...
var _excluded10 = ["aria-label", "aria-labelledby", "action", "centered", "children", "className", "component", "allowScrollButtonsMobile", "indicatorColor", "onChange", "orientation", "ScrollButtonComponent", "scrollButtons", "selectionFollowsFocus", "TabIndicatorProps", "TabScrollButtonProps", "textColor", "value", "variant", "visibleScrollbar"];
...
var Tabs = React18.forwardRef(function Tabs2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTabs"
  });
  ...
  const [indicatorStyle, setIndicatorStyle] = React18.useState(defaultIndicatorStyle);
  const [displayScroll, setDisplayScroll] = React18.useState({
    start: false,
    end: false
  });
  const [scrollerStyle, setScrollerStyle] = React18.useState({
    overflow: "hidden",
    scrollbarWidth: 0
  });
  const valueToIndex = /* @__PURE__ */ new Map();
  const tabsRef = React18.useRef(null);
  const tabListRef = React18.useRef(null);
  const getTabsMeta = () => {
  ...
  const handleScrollbarSizeChange = React18.useCallback((scrollbarWidth) => {
    setScrollerStyle({
      overflow: null,
      scrollbarWidth
    });
  ...
  const handleTabsScroll = React18.useMemo(() => debounce_default(() => {
    updateScrollButtonState();
  }), [updateScrollButtonState]);
  React18.useEffect(() => {
    return () => {
  ...
  let childIndex = 0;
  const children = React18.Children.map(childrenProp, (child) => {
    ...
    childIndex += 1;
    return React18.cloneElement(child, _extends({
...
true ? Tabs.propTypes = {
  ...
  indicatorColor: import_prop_types10.default.oneOf(["primary", "secondary"]),
...
var _excluded13 = ["className", "color", "component", "components", "disabled", "page", "selected", "shape", "size", "type", "variant"];
...
true ? Skeleton.propTypes = {
  ...
  variant: import_prop_types14.default.oneOfType([import_prop_types14.default.oneOf(["circular", "rectangular", "text"]), import_prop_types14.default.string]),
...
function IconContainer(props) {
  const other = _objectWithoutPropertiesLoose(props, _excluded16);
  return (0, import_jsx_runtime34.jsx)("span", _extends({}, other));
}
...
function RatingItem(props) {
  ...
  const container = (0, import_jsx_runtime34.jsx)(RatingIcon, {
  ...
  if (readOnly) {
    return (0, import_jsx_runtime34.jsx)("span", _extends({}, labelProps, {
      children: container
    }));
  }
  return (0, import_jsx_runtime35.jsxs)(React29.Fragment, {
    children: [(0, import_jsx_runtime35.jsxs)(RatingLabel, _extends({
      ownerState: _extends({}, ownerState, {
...
true ? RatingItem.propTypes = {
  ...
  emptyIcon: import_prop_types15.default.node,
  focus: import_prop_types15.default.number.isRequired,
  getLabelText: import_prop_types15.default.func.isRequired,
  highlightSelectedOnly: import_prop_types15.default.bool.isRequired,
  hover: import_prop_types15.default.number.isRequired,
  icon: import_prop_types15.default.node,
  IconContainerComponent: import_prop_types15.default.elementType.isRequired,
  isActive: import_prop_types15.default.bool.isRequired,
  itemValue: import_prop_types15.default.number.isRequired,
  labelProps: import_prop_types15.default.object,
  ...
  ratingValue: import_prop_types15.default.number,
  ratingValueRounded: import_prop_types15.default.number,
  readOnly: import_prop_types15.default.bool.isRequired
} : void 0;
...
var Rating = React29.forwardRef(function Rating2(inProps, ref) {
  ...
  return (0, import_jsx_runtime35.jsxs)(RatingRoot, _extends({
    ref: handleRef,
    ...
    children: [Array.from(new Array(max)).map((_3, index) => {
      ...
      if (precision < 1) {
        ...
        return (0, import_jsx_runtime34.jsx)(RatingDecimal, {
          className: clsx_m_default(classes.decimal, isActive && classes.iconActive),
          ownerState,
          iconActive: isActive,
          children: items.map(($, indexDecimal) => {
            const itemDecimalValue = roundValueToPrecision(itemValue - 1 + (indexDecimal + 1) * precision, precision);
            return (0, import_jsx_runtime34.jsx)(RatingItem, _extends({}, ratingItemProps, {
              isActive: false,
...
true ? Rating.propTypes = {
  ...
  emptyIcon: import_prop_types15.default.node,
  emptyLabelText: import_prop_types15.default.node,
  getLabelText: import_prop_types15.default.func,
  highlightSelectedOnly: import_prop_types15.default.bool,
  icon: import_prop_types15.default.node,
  IconContainerComponent: import_prop_types15.default.elementType,
  max: import_prop_types15.default.number,
  name: import_prop_types15.default.string,
  onChange: import_prop_types15.default.func,
  onChangeActive: import_prop_types15.default.func,
  onMouseLeave: import_prop_types15.default.func,
  onMouseMove: import_prop_types15.default.func,
  precision: chainPropTypes(import_prop_types15.default.number, (props) => {
...
true ? Fab.propTypes = {
  ...
  color: import_prop_types17.default.oneOf(["default", "error", "info", "inherit", "primary", "secondary", "success", "warning"]),
...
var SpeedDial = React32.forwardRef(function SpeedDial2(inProps, ref) {
  ...
  const {
    ...
    TransitionProps
  } = props, FabProps = _objectWithoutPropertiesLoose(props.FabProps, _excluded19), other = _objectWithoutPropertiesLoose(props, _excluded23);
...
var Tooltip = React33.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const positionRef = React33.useRef({
    x: 0,
    y: 0
  });
...
true ? Tooltip.propTypes = {
  ...
  title: import_prop_types19.default.node.isRequired,
...
var SpeedDialAction = React34.forwardRef(function SpeedDialAction2(inProps, ref) {
  ...
  const [tooltipOpen, setTooltipOpen] = React34.useState(tooltipOpenProp);
...
var _excluded24 = ["className", "icon", "open", "openIcon"];
...
var _excluded26 = ["children", "className", "color", "disabled", "exclusive", "fullWidth", "onChange", "orientation", "size", "value"];
...
var _excluded27 = ["addEndListener", "children", "className", "collapsedSize", "component", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "orientation", "style", "timeout", "TransitionComponent"];
...
//# sourceMappingURL=chunk-ZC2R4IRA.js.map
