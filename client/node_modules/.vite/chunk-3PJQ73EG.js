...
var _excluded4 = ["children", "components", "componentsProps", "className", "invisible", "open", "transitionDuration", "TransitionComponent"];
...
var Backdrop = React4.forwardRef(function Backdrop2(inProps, ref) {
  ...
  return (0, import_jsx_runtime4.jsx)(TransitionComponent, _extends({
    ...
    children: (0, import_jsx_runtime4.jsx)(BackdropUnstyled_default, {
      className,
      invisible,
      components: _extends({
        Root: BackdropRoot
...
var _excluded5 = ["BackdropComponent", "closeAfterTransition", "children", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted"];
...
var Modal = React5.forwardRef(function Modal2(inProps, ref) {
  ...
  return (0, import_jsx_runtime5.jsx)(ModalUnstyled_default, _extends({
    components: _extends({
      Root: ModalRoot
    }, components),
    componentsProps: {
...
//# sourceMappingURL=chunk-3PJQ73EG.js.map
